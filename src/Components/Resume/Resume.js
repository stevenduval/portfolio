...
export const Resume = () => {
    ...
    const data = [
        { logoSrc: './images/adp.png', company: 'ADP', title: 'Front-End Development Manager', dates: '3/2023 - Present', tasks: ['Developed and executed marketing campaigns using Salesforce Marketing Cloud (SFMC), leveraging Personalization and Journey Builder.', 'Collaborated with cross-functional teams to evaluate project requirements, provide technical guidance, and drive effective, scalable solutions.', 'Trained and mentored new and existing team members on best practices, workflows, and project-specific technologies.'], skills: 'HTML, CSS, JavaScript, SFMC' },
